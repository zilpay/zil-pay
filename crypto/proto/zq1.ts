...
function writeVarint64(bb: ByteBuffer, value: Long): void {
  ...
  if (size >= 9) {
    bytes[offset + 8] = size === 9 ? part2 & 0x7F : part2 | 0x80;
  }
  if (size >= 8) {
    bytes[offset + 7] = size === 8 ? (part1 >>> 21) & 0x7F : (part1 >>> 21) | 0x80;
  }
  if (size >= 7) {
    bytes[offset + 6] = size === 7 ? (part1 >>> 14) & 0x7F : (part1 >>> 14) | 0x80;
  }
  if (size >= 6) {
    bytes[offset + 5] = size === 6 ? (part1 >>> 7) & 0x7F : (part1 >>> 7) | 0x80;
  }
  if (size >= 5) {
    bytes[offset + 4] = size === 5 ? part1 & 0x7F : part1 | 0x80;
  }
  if (size >= 4) {
    bytes[offset + 3] = size === 4 ? (part0 >>> 21) & 0x7F : (part0 >>> 21) | 0x80;
  }
  if (size >= 3) {
    bytes[offset + 2] = size === 3 ? (part0 >>> 14) & 0x7F : (part0 >>> 14) | 0x80;
  }
  if (size >= 2) {
    bytes[offset + 1] = size === 2 ? (part0 >>> 7) & 0x7F : (part0 >>> 7) | 0x80;
  }
  if (size >= 1) {
    bytes[offset] = size === 1 ? part0 & 0x7F : part0 | 0x80;
  }
}
