<script lang="ts">
    ...
    import { addEthereumChainResponse } from 'popup/background/provider';
    ...
    async function handleApprove() {
        ...
        isLoading = true;
        try {
            await addEthereumChainResponse(addChainEnvelope.uuid, $globalStore.selectedWallet, true);
            
            if (currentWallet.confirm.length === 1) {
    ...
    async function handleCancel() {
        ...
        isLoading = true;
        try {
            await addEthereumChainResponse(addChainEnvelope.uuid, $globalStore.selectedWallet, false);
