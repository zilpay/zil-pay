...
const createEthAddress = () => Address.fromStr('0x0089d53F703f7E0843953D48133f74cE247184c2');
const createZilAddress = () => Address.fromStr('zil1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq9yf6pz');
  ...
  describe('Response Processing', () => {
    ...
    describe('ZIL', () => {
      ...
      it('should process native ZIL balance response', async () => {
        ...
        const balance = await processZilBalanceResponse(mockResponse, mockAccount, true);
      ...
      it('should process ZRC2 token balance response', async () => {
        ...
        const balance = await processZilBalanceResponse(mockResponse, mockAccount, false);
      ...
      it('should return 0 for ZRC2 balance if account not in response', async () => {
        ...
        const mockAccount = await createZilAddress();
        const someOtherChecksumAddress = 'zil10pr0n36fqp0f2s6j32g2qgrgq4yq8n9f0f9g4w';
